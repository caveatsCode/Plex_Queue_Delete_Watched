#utilizes plex api with basic authentication to delete all unwatched videos in plex queue
...
page = requests.get("https://plex.tv/pms/playlists/queue/unwatched", auth=HTTPBasicAuth(username, password))
